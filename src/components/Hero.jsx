            ...
            <div className="relative z-10 text-center w-full max-w-[1200px] text-white flex flex-col items-center">
                ...
                <div className="relative mb-[30px] md:mb-[40px] w-full min-h-[180px] md:min-h-[300px] lg:min-h-[350px] flex items-center justify-center">
                    {slides.map((slide, idx) => (
                        <h1 
                            key={idx} 
                            className={`absolute w-full px-4 text-[2.5rem] md:text-[5rem] lg:text-[7rem] leading-[1] tracking-tighter font-black drop-shadow-[0_10px_30px_rgba(0,0,0,0.6)] transition-all duration-1000 ease-[cubic-bezier(0.19,1,0.22,1)] ${
                                idx === currentSlide 
