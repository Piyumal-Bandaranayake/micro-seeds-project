...
import { freshMicrogreensProducts } from "@/data/freshMicrogreensData";
import { Leaf } from "lucide-react";

export const metadata = {
    title: "Fresh Organic Microgreens | Buy Sunflower, Broccoli & Pea Shoots",
    description: "Our microgreens are grown in a controlled environment without pesticides or chemicals. Freshly harvested and delivered to Colombo and island-wide.",
    alternates: {
        canonical: "https://microgreenslanka.lk/products/fresh-microgreens",
    },
    keywords: "fresh microgreens sri lanka, buy sunflower microgreens, broccoli microgreens, radish microgreens, pea shoots sri lanka",
};

export default function FreshMicrogreensPage() {
    const data = storeCategories.find(c => c.id === "fresh-microgreens");
        ...
        <main className="min-h-screen bg-[var(--color-light)] relative">
            ...
            <section className="relative pt-[120px] md:pt-[180px] pb-[50px] md:pb-[80px] px-[5%] md:px-[8%] text-white overflow-hidden border-b-[4px] border-transparent" style={{ borderImage: "var(--grad-pure-green) 1" }}>
                ...
                <div className="absolute inset-0 z-0">
                    <img src="/f1.jpeg" alt="Fresh Microgreens Background" className="w-full h-full object-cover" />
            ...
            <section className="py-12 md:py-24 px-[5%] md:px-[8%] relative">
                ...
                <div className="max-w-[1400px] mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                    {freshMicrogreensProducts.map((product, idx) => (
